...
// Date:        8/24/2025
// Description: Grade Calculations using Reference Parameters
// Sources: 
...
int main() {
    ...
    calcLetterGrade(finalScore, finalGrade);
...
double assignAverage(int numAssigns){
    // to read the Assignment scores from the user. This function must call readScore every time you read an Assignment score.
